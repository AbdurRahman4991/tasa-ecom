                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="hidden" readonly class="form-control @error('role') is-invalid @enderror" name="role" 
                                    value="{{ old('role', 'customer') }}" required autocomplete="role" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" 
